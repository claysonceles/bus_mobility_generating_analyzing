...
#TODO: you have to change these variable
CURRENT_TIMEZONE = 'America/Los_Angeles'
CURRENT_DAY = '2019-03-11'
ZONE_NUMBER = 10
ZONE_LETTER = 'T'
df_stops_times = pd.read_csv("/home/clayson/globecom_extension/datasets/gtfs/seattle_weekdays/stop_times.txt", dtype={'stop_headsign':'string'})
df_stops = pd.read_csv("/home/clayson/globecom_extension/datasets/gtfs/seattle_weekdays/stops.txt")
df_trips = pd.read_csv("/home/clayson/globecom_extension/datasets/gtfs/seattle_weekdays/trips.txt")
df_shapes = pd.read_csv("/home/clayson/globecom_extension/datasets/gtfs/seattle_weekdays/shapes.txt")
...
def identify_bus_stops(current_shape_id, df_bus_stops):
	...
	#route_shape.to_csv("subset_shapes2.csv", index=False)
...
def identify_bus_stops_by_distance(current_shape_id, df_bus_stops):
	...
	#df_subset_shapes.to_csv("subset_shapes2.csv", index=False)
...
def calibrate(trip_id):
	try:
		...
		#calibrated_traj_latlong[['trip_id','timestamp', 'latitude', 'longitude', 'speed', 'stop_id','stop_name','route_id', 'trip_headsign', 'direction_id', 'shape_id', 'calibrated']].to_csv("trip2.csv", index=False)
		calibrated_traj_latlong[['trip_id','timestamp', 'latitude', 'longitude', 'speed', 'stop_id','stop_name','route_id', 'trip_headsign', 'direction_id', 'shape_id', 'calibrated']].to_csv("/home/clayson/globecom_extension/datasets/calibrated/seattle_weekday/calibrated_traj_"+str(trip_id)+"_.csv", index=False)
