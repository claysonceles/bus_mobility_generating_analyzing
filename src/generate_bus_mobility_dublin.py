...
CURRENT_TIMEZONE = 'Europe/Dublin'
CURRENT_DAY = '2019-06-19'
ZONE_NUMBER = 29
ZONE_LETTER = 'U'
df_stops_times = pd.read_csv("/home/clayson/globecom_extension/datasets/gtfs/dublin_weekdays/stop_times.txt", dtype={'trip_id':'string', 'stop_id':'string', 'stop_headsign':'string'})
df_stops = pd.read_csv("/home/clayson/globecom_extension/datasets/gtfs/dublin_weekdays/stops.txt", dtype={'stop_id':'string'})
df_trips = pd.read_csv("/home/clayson/globecom_extension/datasets/gtfs/dublin_weekdays/trips.txt", dtype={'shape_id':'string', 'route_id':'string', 'trip_id':'string'})
df_shapes = pd.read_csv("/home/clayson/globecom_extension/datasets/gtfs/dublin_weekdays/shapes.txt", dtype={'shape_id':'string'})
...
def calibrate(trip_id):
	try:
		...
		calibrated_traj_latlong[['trip_id','timestamp', 'latitude', 'longitude', 'speed', 'stop_id','stop_name','route_id', 'trip_headsign', 'direction_id', 'shape_id', 'calibrated']].to_csv("/home/clayson/globecom_extension/datasets/calibrated/dublin_weekday/calibrated_traj_"+str(trip_id)+"_.csv", index=False)
